...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
  <tr> 
    <td height="300" align="center" valign="top" bgcolor="#ECE9D8"> 
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td width="5%">　</td>
          <td width="95%" height="40" align="center">管理员：<font color="#FF0000"><strong></strong></font> 
            <font size="2">欢迎进入上海鑫顺管理系统！请慎用您的权限</font></td> 
        </tr>
        <tr> 
          <td colspan="2">　</td>
        </tr>
  ...
  <tr> 
    <td height="30" align="center" bgcolor="#0066CC"> <font color="#FFFFFF"></font></td>
  </tr>
</table>
</body>
</html>