<?php
function tpl_function_solution_category($params, &$smarty)
{
	global $db;
	...
	$aset['showname']=isset($aset['showname'])?$aset['showname']:'solutionlist';
	...
	$result = $db->query("SELECT * FROM ".table('solution_category')." ".$wheresql." ORDER BY  category_order DESC");
	$list=array();
