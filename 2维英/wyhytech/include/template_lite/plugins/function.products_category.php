<?php
function tpl_function_products_category($params, &$smarty)
{
	global $db;
	...
	$aset['showname']=isset($aset['showname'])?$aset['showname']:'productslist';
	...
	$result = $db->query("SELECT * FROM ".table('products_category')." ".$wheresql." ORDER BY  category_order DESC");
	$list=array();
