<?php require_once('D:\website\wyhytech\include\template_lite\plugins\function.contact_category.php'); $this->register_function("contact_category", "tpl_function_contact_category",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2016-12-23 14:02 �й���׼ʱ�� */ ?>
      ...
      <table width="100%" border="0" cellpadding="3" cellspacing="5"  >
        <tr>
		  ...
		  <select name="parentid" id="parentid"  style="width:108px; font-size:12px;">
			  ...
			  <?php echo tpl_function_contact_category(array('set' => "列表名:categorylist,联系我们大类:0"), $this);?>
