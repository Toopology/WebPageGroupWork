<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2016-12-27 17:10 �й���׼ʱ�� */ ?>
...
"
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0" class="admin_table">
      <tr>
        ...
        <td width="200" >
<label><input name="is_display" type="radio" value="1" checked="checked"  <?php if ($this->_vars['edit_about']['is_display'] == "1"): ?>checked="checked"  <?php endif; ?>/>显示</label>
<label><input type="radio" name="is_display" value="0" <?php if ($this->_vars['edit_about']['is_display'] == "0"): ?>checked="checked"  <?php endif; ?>/> 不显示</label>
