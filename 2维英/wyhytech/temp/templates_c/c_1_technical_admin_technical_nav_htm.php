...
<div class="topnav">
    <a href="admin_technical.php?act=list" <?php if ($this->_vars['act'] == 'list'): ?>class="select"<?php endif; ?>><u>淇℃伅鍒楄〃</u></a>
    <a href="admin_technical.php?act=technical_add" <?php if ($this->_vars['act'] == 'technical_add'): ?>class="select"<?php endif; ?>><u>娣诲姞淇℃伅</u></a>
