<?php require_once('D:\website\wyhytech\include\template_lite\plugins\modifier.default.php'); $this->register_modifier("default", "tpl_modifier_default",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2017-01-20 15:43 �й���׼ʱ�� */ ?>
...
<label><input type="radio" name="is_display" value="0" /> 不显示</label>
        ...
        <td ><input name="about_order" type="text"  class="input_text_150" id="about_order" style="width:50px;" maxlength="8" onkeyup="if(event.keyCode !=37 && event.keyCode != 39) value=value.replace(/\D/g,'');"onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/\D/g,''))"/>
