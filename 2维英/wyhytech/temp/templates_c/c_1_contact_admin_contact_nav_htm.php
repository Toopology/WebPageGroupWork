...
<div class="topnav">
    <a href="admin_contact.php?act=list" <?php if ($this->_vars['act'] == 'list'): ?>class="select"<?php endif; ?>><u>淇℃伅鍒楄〃</u></a>
    <a href="admin_contact.php?act=contact_add" <?php if ($this->_vars['act'] == 'contact_add'): ?>class="select"<?php endif; ?>><u>娣诲姞淇℃伅</u></a>
