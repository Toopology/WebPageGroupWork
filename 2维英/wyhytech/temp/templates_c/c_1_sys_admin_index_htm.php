...
<frameset rows="70,*" frameborder="no" border="0" framespacing="0" >
    <frame src="main.php?act=top" name="topFrame" id="topFrame" scrolling="no" frameborder="NO" border="0" framespacing="0">
    <frameset cols="200,*"  name="bodyFrame" id="bodyFrame" frameborder="no" border="0" framespacing="0">
        ...
        <frame src="main.php?act=main" name="mainFrame" frameborder="no" scrolling="auto" noresize id="mainFrame">
    </frameset>
</frameset>
    <noframes>
        <body>浣犵殑娴忚鍣ㄤ笉鏀寔妗嗘灦</body>
    </noframes>
</html>