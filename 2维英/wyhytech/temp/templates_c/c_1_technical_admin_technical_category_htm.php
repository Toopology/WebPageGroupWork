...
删除顶级级分类将会自动删除此分类下的子分类。
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan"  >
	...
	<?php echo tpl_function_technical_category(array('set' => "列表名:category,培训大类:0"), $this);?>
...
">删除</a>
			...
			<!--&lt;!&ndash;小类 &ndash;&gt;
			<?php echo tpl_function_technical_category(array('set' => $this->_run_modifier("列表名:sclass,培训大类:", 'cat', 'plugin', 1, $this->_vars['list']['id'])), $this);?>
