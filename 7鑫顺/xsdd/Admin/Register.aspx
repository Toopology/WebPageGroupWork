<%@ page title="注册" language="C#" masterpagefile="~/Datainput/MasterPage.master" autoeventwireup="true" inherits="Account_Register, App_Web_0uhcuhou" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:CreateUserWizard ID="RegisterUser" runat="server" 
        ...
        FinishDestinationPageUrl="~/Admin/RoleManage.aspx" 
        ContinueDestinationPageUrl="~/Admin/RoleManage.aspx" LoginCreatedUser="False">
        <LayoutTemplate>
