<%@ page title="更改密码" language="C#" masterpagefile="~/Datainput/MasterPage.master" autoeventwireup="true" inherits="Account_ChangePassword, App_Web_z5m2xkpl" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:ChangePassword ID="ChangeUserPassword" runat="server" CancelDestinationPageUrl="~/datainput/default.aspx" EnableViewState="false" RenderOuterTable="false" 
            ...
            <div class="accountInfo">
                ...
                <p class="submitButton">
                    <asp:Button ID="CancelPushButton" runat="server" CausesValidation="False" 
                        CommandName="Cancel" Text="取消" PostBackUrl="~/datainput/default.aspx"/>
