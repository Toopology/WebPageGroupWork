<%@ page title="鑫顺典当 -  服务流程" language="C#" masterpagefile="~/mainpage.master" autoeventwireup="true" inherits="Fuwuliucheng_xudang, App_Web_npfhy52l" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="MainContent">
     <tr>
				...
				<table width="100%" height="53" border="0" cellpadding="6" cellspacing="0">
                  <tr>
                    <td height="53" align="center"><span class="STYLE4">续当流程</span></td>
                    </tr>
                </table>
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
				 ...
				 <DIV> <DIV align=center> <P><IMG src="liucheng/xudanglc.gif" border=0> </P></DIV></DIV>
				</td>
              </tr>
              <tr>
