<%@ page title="鑫顺典当 -  典当行规" language="C#" masterpagefile="~/mainpage.master" autoeventwireup="true" inherits="Ddhg, App_Web_npfhy52l" %>
...
<p>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [vw_DDHG] order by approved_date desc">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            <Columns>
                ...
                <asp:BoundField  HeaderText="updated_dt" 
