<%@ page title="鑫順典当 - 招贤纳才" language="C#" masterpagefile="~/mainpage.master" autoeventwireup="true" inherits="Job, App_Web_npfhy52l" %>
...
<asp:Content ID="Content2" runat="server" contentplaceholderid="MainContent">
    <table width="100%" height="53" border="0" cellpadding="6" cellspacing="0">
        <tr>
            <td height="53" align="center"><span class="STYLE4">招贤纳才</span></td>
        </tr>
    </table>
