            ...
            <ul class="news_list3">
                        <%
                                ...
                                <li>
                                	<table width="100%">
                                    	<tr>
                                        	<td width="13%"><a href="detail.asp?id=<%=rs("id")%>"><img src="<%=rs("preview")%>" width="80" height="60" style="border:1px solid #CCC; padding:1px;" /></a></td>
                                            <td width="87%" valign="top"><span><%=format_time(rs("addtime"),2)%></span>
                                	<a style="font-size:14px; color:#039; font-weight:bold" href="detail.asp?id=<%=rs("id")%>"><%=rs("title")%></a>
