var kfguin="83323983¡¡";
var qq_group="83323983¡¡";
var ws="www.fm61.net"; 
var companyname="¸¸Ä¸Íø"; 
var welcomeword="ÄúºÃ,»¶Ó­¹âÁÙ¸¸Ä¸Íø<brT>ÇëÎÊ,ÓÐÊ²Ã´¿ÉÒÔ°ïµ½ÄúµÄÂð?";
var type="0";
...
if(kfguin)
{
  rightDivHtml = '<div id="rightDivQQ" style="position:absolute; top:160px; right:10px;">';
...
{ 
	 ...
	 document.getElementById("rightDivQQ").style.top = parseInt(document.getElementById("rightDivQQ").style.top) + percent+"px";
...
function kf_hide() 
{
	...
	document.getElementById("rightDivQQ").style.visibility = "hidden";
}
...
{	
	...
	temp += '<div class="wpa_popup" style="width:90px; height:200px;background:url('+urlroot+'middle.jpg);"><div style="padding:130px 0 0 7px">';
  temp += '<a href="feedback.asp"><img border=0 src="img/btn1.jpg" /></a>';
  temp += '<a href="join_us.asp"><img border=0 src="img/btn2.jpg" /></a>';
  temp += '</div></div>';
...
{   
	...
	var position = parseInt(document.getElementById("rightDivQQ").style.top) + 170;
